...
const state = {
  ...
  device: "bass", // which voice; per-voice panels load a copy with this baked
  duration: 8,
  hint: "",
  tempo: 0,
  kitUri: "",
  ...
  plan: "starter_bass", // dataset recording plan; per-voice panels bake theirs
};
...
status("mouthflow bass ready · 95f44c0*");
